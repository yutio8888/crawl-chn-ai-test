...
{
#if TAG_MAJOR_VERSION == 34
    { OBJ_ARMOUR,    ARM_TROLL_HIDE },
    { OBJ_ARMOUR,    ARM_FIRE_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_ICE_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_STEAM_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_ACID_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_STORM_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_GOLDEN_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_SWAMP_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_PEARL_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_SHADOW_DRAGON_HIDE },
    { OBJ_ARMOUR,    ARM_QUICKSILVER_DRAGON_HIDE },
...
static string _xp_evoker_recharge_msg(const item_def &evoker, int gained, bool silenced)
{
    ...
    return make_stringf(gained == 1
                        ? T_("%%s has regained %d charge.")
                        : T_("%%s has regained %d charges."), gained);
}
