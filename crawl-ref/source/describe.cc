...
int show_description(const describe_info &inf, const tile_def *tile)
{
    ...
    const char* mores[2] = {
        T_("[<w>!</w>]: <w>Description</w>|Quote"),
        T_("[<w>!</w>]: Description|<w>Quote</w>"),
    };
...
static const vector<property_descriptor> & _get_all_artp_desc_data()
{
    ...
    {
        { ARTP_AC,
            N_("It affects your AC (%d)."),
            prop_note::numeral },
        { ARTP_EVASION,
            N_("It affects your evasion (%d)."),
            prop_note::numeral },
        { ARTP_STRENGTH,
            N_("It affects your strength (%d)."),
            prop_note::numeral },
        { ARTP_INTELLIGENCE,
            N_("It affects your intelligence (%d)."),
            prop_note::numeral },
        { ARTP_DEXTERITY,
            N_("It affects your dexterity (%d)."),
            prop_note::numeral },
        { ARTP_SLAYING,
            N_("It affects your accuracy & damage with ranged weapons and melee (%d)."),
            prop_note::numeral },
        { ARTP_FIRE,
            NC_("element", "fire"),
            prop_note::symbolic },
        { ARTP_COLD,
            ...
            prop_note::symbolic },
        { ARTP_ELECTRICITY,
            N_("It insulates you from electricity."),
            prop_note::plain },
        { ARTP_POISON,
            N_("It protects you from poison."),
            prop_note::plain },
        { ARTP_NEGATIVE_ENERGY,
            NC_("element", "negative energy"),
            prop_note::symbolic },
        { ARTP_WILLPOWER,
            N_("buggy willpower"),
            prop_note::symbolic },
        { ARTP_HP,
            N_("It affects your health (%d)."),
            prop_note::numeral },
        { ARTP_MAGICAL_POWER,
            N_("It affects your magic capacity (%d)."),
            prop_note::numeral },
        { ARTP_SEE_INVISIBLE,
            N_("It lets you see invisible."),
            prop_note::plain },
        { ARTP_INVISIBLE,
            N_("It lets you turn invisible."),
            prop_note::plain },
        { ARTP_FLY,
            N_("It grants you flight."),
            prop_note::plain },
        { ARTP_BLINK,
            N_("It lets you blink."),
            prop_note::plain },
        { ARTP_NOISE,
            N_("It may make a loud noise when swung."),
            prop_note::plain },
        { ARTP_PREVENT_SPELLCASTING,
            N_("It prevents spellcasting."),
            prop_note::plain },
        { ARTP_PREVENT_TELEPORTATION,
            N_("It prevents most forms of teleportation."),
            prop_note::plain },
        { ARTP_ANGRY,
            N_("It berserks you when you make melee attacks (%d% chance)."),
            prop_note::plain },
        { ARTP_CLARITY,
            N_("It protects you from confusion, rage, mesmerisation and fear."),
            prop_note::plain },
        { ARTP_CONTAM,
            N_("It causes magical contamination when unequipped."),
            prop_note::plain },
        { ARTP_RMSL,
            N_("It protects you from missiles."),
            prop_note::plain },
        { ARTP_REGENERATION,
            N_("It increases your rate of health regeneration."),
            prop_note::symbolic },
        { ARTP_RCORR,
            N_("It protects you from acid and corrosion."),
            prop_note::plain },
        { ARTP_RMUT,
            N_("It protects you from mutation."),
            prop_note::plain },
        { ARTP_CORRODE,
            N_("It may corrode you when you take damage."),
            prop_note::plain },
        { ARTP_DRAIN,
            N_("It drains your maximum health when unequipped."),
            prop_note::plain },
        { ARTP_SLOW,
            N_("It may slow you when you take damage."),
            prop_note::plain },
        { ARTP_FRAGILE,
            N_("It will be destroyed if unequipped."),
            prop_note::plain },
        { ARTP_SHIELDING,
            N_("It affects your SH (%d)."),
            prop_note::numeral },
        { ARTP_HARM,
            N_("It increases damage dealt and taken."),
            prop_note::plain },
        { ARTP_RAMPAGING,
            N_("It causes one to take an extra step when moving towards enemies, briefly stunning them if this results in an attack."),
            prop_note::plain },
        { ARTP_STEALTH,
            N_("buggy stealth"),
            prop_note::symbolic },
        { ARTP_ARCHMAGI,
            N_("It increases the power of your magical spells."),
            prop_note::plain },
        { ARTP_ENHANCE_CONJ,
            N_("It increases the power of your Conjurations spells."),
            prop_note::plain },
        { ARTP_ENHANCE_HEXES,
            N_("It increases the power of your Hexes spells."),
            prop_note::plain },
        { ARTP_ENHANCE_SUMM,
            N_("It increases the power of your Summonings spells."),
            prop_note::plain },
        { ARTP_ENHANCE_NECRO,
            N_("It increases the power of your Necromancy spells."),
            prop_note::plain },
        { ARTP_ENHANCE_TLOC,
            N_("It increases the power of your Translocations spells."),
            prop_note::plain },
        { ARTP_ENHANCE_FIRE,
            N_("It increases the power of your Fire spells."),
            prop_note::plain },
        { ARTP_ENHANCE_ICE,
            N_("It increases the power of your Ice spells."),
            prop_note::plain },
        { ARTP_ENHANCE_AIR,
            N_("It increases the power of your Air spells."),
            prop_note::plain },
        { ARTP_ENHANCE_EARTH,
            N_("It increases the power of your Earth spells."),
            prop_note::plain },
        { ARTP_ENHANCE_ALCHEMY,
            N_("It increases the power of your Alchemy spells."),
            prop_note::plain },
        { ARTP_ENHANCE_FORGECRAFT,
            N_("It increases the power of your Forgecraft spells."),
            prop_note::plain },
        { ARTP_ACROBAT,
            N_("It increases your evasion after moving or waiting."),
            prop_note::plain },
        { ARTP_MANA_REGENERATION,
            N_("It increases your rate of magic regeneration."),
            prop_note::symbolic },
        { ARTP_WIZARDRY,
            N_("It increases the success rate of your magical spells."),
            prop_note::plain },
        { ARTP_SILENCE,
            N_("It may silence you when you take damage."),
            prop_note::plain },
        { ARTP_BANE,
            N_("It inflicts you with a random bane when you equip it."),
            prop_note::plain },
    };
    return data;
}
...
void desc_randart_props(const item_def &item, vector<string> &lines)
{
    ...
    for (artefact_prop_type prop : artprop_annotation_order)
    {
        ...
        string sdesc = desc.display_type == prop_note::symbolic
                       && desc.property != ARTP_REGENERATION
                       && desc.property != ARTP_MANA_REGENERATION
                       ? C_("element", desc.desc)
                       : T_(desc.desc);
...
static string _describe_demon(const string& name, bool flying, colour_t colour)
{
    ...
    static const char* wing_names[] =
    {
        ...
        N_("with bony wings"),
        N_("with sharp, metallic wings"),
        N_("with the wings of a moth"),
        N_("with thin, membranous wings"),
        N_("with dragonfly wings"),
        N_("with large, powerful wings"),
        N_("with fluttering wings"),
        N_("with great, sinister wings"),
        N_("with hideous, tattered wings"),
        N_("with sparrow-like wings"),
        N_("with hooked wings"),
        N_("with strange knobs attached"),
    ...
    static const char* misc_descs[] =
    {
        ...
        N_(" Its body is covered in fungus."),
        N_(" It is covered with lank hair."),
        ...
        N_(" It seems utterly heartbroken."),
        N_(" It seems filled with irrepressible glee."),
        N_(" It constantly shivers and twitches."),
        N_(" Blue sparks crawl across its body."),
        N_(" It seems uncertain."),
        N_(" A cloud of flies swarms around it."),
        N_(" The air around it ripples with heat."),
        N_(" Crystalline structures grow on everything near it."),
        N_(" It appears supremely confident."),
        N_(" Its skin is covered in a network of cracks."),
        N_(" Its skin has a disgusting oily sheen."),
        N_(" It seems somehow familiar."),
        N_(" It is somehow always in shadow."),
        N_(" It is difficult to look away."),
        N_(" It is constantly speaking in tongues."),
        N_(" It babbles unendingly."),
        N_(" Its body is scourged by damnation."),
        N_(" Its body is extensively scarred."),
        N_(" You find it difficult to look away."),
        N_(" Oddly mechanical noises accompany its jarring movements."),
        N_(" Its skin looks unnervingly wrinkled."),
    };

    static const char* smell_descs[] =
    {
        N_(" It smells of brimstone."),
        N_(" It is surrounded by a sickening stench."),
        N_(" It smells of rotting flesh."),
        N_(" It stinks of death."),
        N_(" It stinks of decay."),
        N_(" It smells delicious!"),
    };
...
static string _describe_mutant_beast_tier(int tier)
{
    const string tier_descs[] = {
        ...
        T_("It is mature, stronger than a juvenile but weaker than its elders."),
        T_("It is an elder, stronger than mature beasts."),
        T_("It is a primal beast, the most powerful of its kind."),
    };
...
static string _describe_mutant_beast_facets(const CrawlVector &facets)
{
    const string facet_descs[] = {
        ...
        T_("s breath smoulders ominously"),
        T_(" is covered with eyes and tentacles"),
        T_(" flickers and crackles with electricity"),
        T_(" is covered in dense fur and muscle"),
    };
                                        ...
                                        unsigned int training)
{
    ...
    {
        description += make_stringf(T_("At current training (%d%%) "),
                                    you.training[skill]);
    }
    else
...
static string _warlock_mirror_reflect_desc()
{
    ...
    return make_stringf(T_("\n\nWith your current SH, it has a %d%% chance to reflect attacks against your willpower and other normally unblockable effects."), reflect_chance);
}
    ...
    if (item.brand)
    {
        ...
        switch (item.brand)
        {
            case SPGIZMO_SPELLMOTOR:
                desc = T_("Your spells cost less MP as you Rev up. Whenever you "
                       "cast a spell, you make a melee attack against a random "
                       "enemy in range.");
                break;

            case SPGIZMO_GADGETEER:
                desc = T_("Your evocable items recharge 30% faster and wands have "
                       "a 30% chance to not spend a charge.");
                break;

            case SPGIZMO_REVGUARD:
                desc = T_("Your AC increases as you Rev (up to +5) and while "
                       "fully Revved, your attacks may disarm enemies.");
                break;

            case SPGIZMO_AUTODAZZLE:
                desc  = T_("It sometimes fires a blinding ray at enemies whose attacks "
                       "you dodge.");
                break;
...
static void _uselessness_desc(ostringstream &description, const item_def &item)
{
    ...
    if (is_useless_item(item, true))
    {
        ...
        {
            description << (T_("This ")) << base_type_string(item.base_type)
                        << (T_(" is completely useless to you"));
        ...
        else
        {
            ...
            {
            case OBJ_SCROLLS:
                description << (T_("Reading this right now"));
                // this is somewhat heuristic:
                if (cannot_read_item_reason().size())
                    description << (T_(" isn't possible"));
                else
                    description << (T_(" will have no effect"));
                break;
            case OBJ_POTIONS:
                // XX code dup
                description << (T_("Drinking this right now"));
            ...
            case OBJ_MISCELLANY:
            case OBJ_WANDS:
                description << (T_("You can't evoke this right now"));
                break;
            default:
                description << (T_("This ")) << base_type_string(item.base_type)
                            << (T_(" is useless to you right now"));
                break;
            }
                            ...
                            item_description_mode mode)
{
                    ...
                    && item.base_type != OBJ_BOOKS))
    {
        ...
        {
            description << (T_("It is an ancient artefact."));
            need_base_desc = false;
        }
        else if (item.base_type == OBJ_GIZMOS)
        {
            description << (T_("It is a fabulous contraption, custom-made by your own hands."));
            need_base_desc = false;
        }
        ...
        if (need_base_desc)
        {
            ...
            // Fallback: try English name for Chinese translation compatibility.
            // The descript database uses English keys, but item.name() may
            // return Chinese names when Options.language == ZH.
            if (db_desc.empty() && Options.language == lang_t::ZH)
            {
                const lang_t saved = Options.language;
                Options.language = lang_t::EN;
                string en_db_name = item.name(DESC_DBNAME, true, false, false);
                Options.language = saved;
                if (en_db_name != db_name)
                    db_desc = getLongDescription(en_db_name);
            }
    ...
    case OBJ_MISCELLANY:
        ...
        if (verbose)
        {
            ...
            if (is_xp_evoker(item))
            {
                ...
                if (charges > 1)
                    description << (T_("Charges: ")) << charges << (T_(". Once all charges have been used"));
                else
                    description << (T_("Once activated"));
                description << T_(", this device is rendered temporarily inert. ")
                            << T_("However, it recharges as you gain experience.");

                if (evoker_plus(item.sub_type) < MAX_EVOKER_ENCHANT)
                {
                    description << "\n\n"
                            << T_("Additional devices of the same type ")
                            << T_("can be combined with it to improve the rate at ")
                            << T_("which it recharges.");
                }
                if (!is_useless_skill(SK_EVOCATIONS)
                       && you.skill(SK_EVOCATIONS) < MAX_SKILL_LEVEL)
                {
                    description << "\n\n"
                                << T_("Increasing your evocations skill will ")
                                << T_("improve the rate at which it recharges.");
                }

                const string damage_str = evoke_damage_string(item);
                if (damage_str != "")
                    description <<"\n" << T_("Damage: ") << damage_str;
    ...
    case OBJ_POTIONS:
        if (item.is_identified())
        {
            if (verbose)
            {
                ...
                {
                    description << "\n\n" << T_("If you drink this now, you will no longer be ") <<
...
string get_cloud_desc(cloud_type cloud, bool include_title)
{
    ...
    string ret;
    if (include_title)
        ret = T_("A cloud of ") + cl_name + (cl_desc.empty() ? "." : ".\n\n");
...
void get_feature_desc(const coord_def &pos, describe_info &inf, bool include_extra)
{
    ...
    if (feat_is_stair(feat))
    {
        ...
        else if (feat_is_staircase(feat) || feat_is_escape_hatch(feat))
        {
            ...
            {
                long_desc += T_(" You have not yet explored it and cannot tell "
                             "where it leads.");
            }
            else
            {
                const command_type look_dir =
                    feat_stair_direction(feat) == CMD_GO_UPSTAIRS
                                         ...
                                         : CMD_MAP_NEXT_LEVEL;
                long_desc +=
                    make_stringf(T_(" You can view the location it leads to by "
        ...
        else if (feat_is_gate(feat))
        {
            ...
            long_desc += make_stringf(
                    ...
                    stair_dir == CMD_GO_DOWNSTAIRS ? T_("enter") : T_("exit"),
                    how.c_str(),
                    _esc_cmd_to_str(stair_dir).c_str(),
                    (feat == DNGN_ENTER_ZOT || feat == DNGN_EXIT_VAULTS)
                        ? T_(" if you have enough runes") : "");
        }
    }
    ...
    if (feat_is_door(feat) && feat != DNGN_BROKEN_DOOR && feat != DNGN_BROKEN_CLEAR_DOOR)
    {
        ...
        long_desc += make_stringf(
            ...
            "<w>%s</w> key."),
            sealed ? T_("normally ") : "",
            openable ? T_("open") : T_("close"),
            command_to_string(openable ? CMD_OPEN_DOOR : CMD_CLOSE_DOOR).c_str());
        if (sealed)
            long_desc += T_(" However, this will not work until the sealing runes wear off.");
    }
...
void inscribe_item(item_def &item)
{
    ...
    string prompt = is_inscribed ? T_("Replace inscription with what?")
                                 : T_("Inscribe with what?");
    prompt += " ";
...
string get_skill_description(skill_type skill, bool need_title)
{
    ...
    if (skill == SK_INVOCATIONS)
    {
        ...
        {
            result += "\n";
            result += T_("How on earth did you manage to pick this up?");
        }
        else if (invo_skill(you.religion) != SK_INVOCATIONS)
        {
            result += "\n";
            result += uppercase_first(apostrophise(god_name(you.religion)))
                      + T_(" powers are not affected by the Invocations skill.");
        }
    }
    else if (skill == invo_skill(you.religion))
    {
        result += "\n";
        result += uppercase_first(apostrophise(god_name(you.religion)))
                  + make_stringf(T_(" powers are based on %s instead"
...
static string _player_spell_desc(spell_type spell)
{
    ...
    {
        string str = you.props[GRAVE_CLAW_CHARGES_KEY].get_int() == 1
            ? make_stringf(T_("\nYou have harvested enough death to cast this spell %d time. (Maximum of %d.)"),
                           you.props[GRAVE_CLAW_CHARGES_KEY].get_int(), GRAVE_CLAW_MAX_CHARGES)
            : make_stringf(T_("\nYou have harvested enough death to cast this spell %d times. (Maximum of %d.)"),
                           you.props[GRAVE_CLAW_CHARGES_KEY].get_int(), GRAVE_CLAW_MAX_CHARGES);
        description << str;
    }
                                  ...
                                  string &description)
{
    ...
    const string long_descrip = getLongDescription(string(spell_english_name(spell))
                                                   + " spell");
    ...
    {
        description += T_("This spell has no description. Casting it may therefore be unwise. ");
#ifdef DEBUG
                       T_("Better go fix it.");
#else
                       T_("Please submit a bug report.");
#endif
    }
            ...
            )
        {
            ...
            description += you.immune_to_hex(spell)
                ? make_stringf(T_("You cannot be affected by this "
                               "spell right now. %s\n"),
                               wiz_info.c_str())
                : make_stringf(T_("Chance to defeat your Will: %d%%%s\n"),
...
void describe_mutation(mutation_type mut)
{
    ...
    {
        inf.title += make_stringf(T_(" (level %d/%d)"),
...
string bane_long_description(bane_type bane, bool ignore_player)
{
    ...
    if (dur > BANE_DUR_LONG)
        dur_str = T_("very long");
    else if (dur > BANE_DUR_MEDIUM)
        dur_str = T_("long");
    else if (dur > BANE_DUR_SHORT)
        dur_str = T_("moderate length of");
    else
        dur_str = T_("short length of");

    output << make_stringf(T_("\nThis bane usually lasts a %s time.\n"), dur_str.c_str());

    if (player_has)
    {
        int needed_xl = xl_to_remove_bane(bane);
        string desc = make_stringf(T_("\n<lightmagenta>"
...
static const char* _get_resist_name(mon_resist_flags res_type)
{
    ...
    case MR_RES_COLD:
        return T_("cold");
    case MR_RES_CORR:
        return T_("acid and corrosion");
    case MR_RES_MIASMA:
        return T_("miasma");
    case MR_RES_NEG:
        return T_("negative energy");
                                        ...
                                        mon_attack_desc_info &di)
{
    ...
    if (quiv->sub_type == MI_THROWING_NET)
        bonus_desc = T_("Ensnare in a net");
    else if (quiv->sub_type == MI_DART)
    {
        switch (quiv->brand)
        {
        case SPMSL_CURARE:
            dam_desc = T_("12 (curare)"); // direct curare damage is 2d6
            bonus_desc = T_("Poison and slowing");
            break;
        case SPMSL_POISONED:
            bonus_desc = T_("Poison");
            break;
        case SPMSL_BLINDING:
            bonus_desc = T_("Blinding and confusion");
            break;
        case SPMSL_FRENZY:
            bonus_desc = T_("Drive defenders into a frenzy");
            break;
        case SPMSL_DISPERSAL:
            bonus_desc = T_("Blink the defender away");
            break;
        case SPMSL_DISJUNCTION:
            bonus_desc = T_("Blink the defender repeatedly");
        default:
            break;
        }
    }
    else // ordinary missiles
    {
        ...
        if (quiv->brand == SPMSL_SILVER)
        {
            ...
            silver_str = make_stringf(
                T_(" + %d (silver)"), silver_dam);
        }
...
// Calculate display width of a string (CJK characters = 2, ASCII = 1)
static int _str_display_width(const string &s)
{
    int width = 0;
...
// Pad a string to a given display width (not codepoint count)
static string _pad_to_display_width(const string &s, int pad_to, bool prepend = false)
{
    const int padding = pad_to - _str_display_width(s);
    if (padding <= 0)
        return s;
    string str = s;
    if (prepend)
...
public:
    ...
    {
        // Use display width for CJK-aware layout
        vector<int> labels_widths_by_col;
        for (size_t row = 0; row < rows.size(); ++row)
        {
            for (size_t col = 0; col < rows[row].size(); ++col)
            {
                const int label_w = _str_display_width(rows[row][col].label);
                if (col == labels_widths_by_col.size())
                    labels_widths_by_col.push_back(label_w);
                else
                    labels_widths_by_col[col] = max(labels_widths_by_col[col], label_w);
            }
        }
        const int cell_len = fixed_column_width > 0 ? fixed_column_width
                                : 80 / max(1, (int)labels_widths_by_col.size());
        ...
        for (const auto &row : rows)
        {
            for (size_t col = 0; col < row.size(); ++col)
            {
                ...
                const int label_w = labels_widths_by_col[col];
                const string label = _pad_to_display_width(cell.label, label_w, true);
                const string body = make_stringf("%s: %s",
                                                 label.c_str(),
                                                 cell.value.c_str());
                result << colourize_str(_pad_to_display_width(body, cell_len), cell.colour);
            }
            result << "\n";
        }
    }
...
static string _res_name(mon_resist_flags res)
{
    ...
    case MR_RES_COLD:   return T_("rC");
    case MR_RES_POISON: return T_("rPois");
...
static string _monster_stat_description(const monster_info& mi, bool mark_spells)
{
    ...
    if (mi.type == MONS_STAR_JELLY)
    {
        ...
        result << (T_("Shooting star damage: "))
               << dmg.num << "d" << dmg.size << " (x3)\n";
    }
    ...
    if (in_good_standing(GOD_ZIN, 0) && !mi.pos.origin() && monster_at(mi.pos))
    {
        ...
        {
            result << uppercase_first(pronoun)
                   << (T_(" cannot be affected by reciting Zin's laws."));
        }
        else if (eligibility == RE_TOO_STRONG)
        {
            result << uppercase_first(pronoun)
                   << (T_(" is too strong to be affected by reciting Zin's laws."));
        }
        else // RE_ELIGIBLE || RE_RECITE_TIMER
        {
            result << uppercase_first(pronoun)
                   << (T_(" can be affected by reciting Zin's laws."));
        }
...
{
    const string rank = T_(xl_rank_names[xl_rank]);
...
static string _describe_talisman_form(transformation form_type)
{
    ...
    items.push_back({" ", T_("Min"), T_("Max"), T_("Cur")});
...
string extra_cloud_info(cloud_type cloud_type)
{
    ...
    const string vanish_info
        = make_stringf(T_("\nClouds of this kind an adventurer makes will vanish"
                       ...
                       opaque ? T_("quickly") : T_("almost instantly"));
