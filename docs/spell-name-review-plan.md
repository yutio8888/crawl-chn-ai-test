...
- [ ] 实体、元素和状态术语系列
  ...
  - [x] Permafrost Eruption（1 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Lightning/Electricity/Thunder 元素系列（10 项均已审阅；6 项复用既有证据，translation profile 已完成）
  - [x] Glaciate/Iceblast/Hailstorm 寒冷术语批次（3 项证据、裁定、名称与描述落地及 translation profile 已完成）
  - [x] Fireball 词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Death 独立词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Teleport 词形系列（3 项证据、裁定、名称与描述落地及 translation profile 已完成）
  - [x] Control 词形系列（3 项均已审阅；1 项复用既有证据，translation profile 已完成）
  - [x] Fire Storm 词形系列（2 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Haste 词形系列（3 项证据、裁定及 translation profile 已完成）
  - [x] Invisibility 词形系列（2 项证据、裁定、名称落地及 translation profile 已完成）
  - [x] Abjuration 词形系列（2 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Infusion 词形系列（3 项兼容标题证据、裁定及 translation profile 已完成）
  - [x] Song 词形系列（3 项证据、裁定及 translation profile 已完成）
  - [x] Animate 词形系列（2 项证据、裁定、名称与描述落地及 translation profile 已完成）
  - [x] Shot 词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Hurl 词形系列（3 项证据、裁定、名称与描述落地及 translation profile 已完成）
  - [x] Launch 词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Blast 词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Blade 词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Destruction 词形系列（4 项证据、裁定、名称落地及 translation profile 已完成）
  - [x] Warp 词形系列（3 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Might/Other 目标系列（5 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Vortex 词形系列（2 项证据、裁定、名称与描述落地及 translation profile 已完成）
  - [x] Strike 词形系列（2 项证据、裁定及 translation profile 已完成）
  - [x] Sacrifice 词形系列（2 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Regeneration 词形系列（2 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Recall 词形系列（2 项证据、裁定及 translation profile 已完成）
  - [x] Phantom 词形系列（2 项证据、裁定、描述落地及 translation profile 已完成）
  - [x] Missiles 词形系列（2 项证据、裁定、描述落地及 translation profile 已完成）
- [ ] 独立法术
- [ ] 集合相等性终检
