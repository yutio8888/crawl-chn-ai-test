...
| Policy | Source | Generated role consumers |
|---|---|---|
| i18n safety | `.agents/policies/i18n-safety.md` | coder and code-reviewer roles |
| review contract | `.agents/policies/review-contract.md` | code and translation reviewer roles |
| asset ownership | `.agents/policies/asset-ownership.md` | coder and translator roles |
| verification authoring | `.agents/policies/verification-authoring.md` | coder and code-reviewer roles |
| translation integrity | `.agents/policies/translation-integrity.md` | translator roles |
