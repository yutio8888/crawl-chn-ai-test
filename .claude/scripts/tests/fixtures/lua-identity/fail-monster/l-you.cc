...
static int l_you_monster(lua_State *ls) { string decoy = mons_type_name_en(you.mons_species(), DESC_PLAIN); string name = T_("localized"); lowercase(name); lua_pushstring(ls, name.c_str()); return 1; }
